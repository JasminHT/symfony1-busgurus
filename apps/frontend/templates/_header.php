...
<?php if($culture == "en") { ?>
<ul id="mainNav"> 
    <li id='mainNav-library'><?php echo link_to("<div></div>Library","@resources?sf_culture=".$sf_user->getCulture());?></li>
...
<?php }else { ?> <!--fr-->
<ul id="mainNav"> 
    <li id='mainNav-library'><?php echo link_to('<div></div>Biblioth&egrave;que',"@resources?sf_culture=".$sf_user->getCulture());?></li>
