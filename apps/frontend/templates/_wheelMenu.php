...
<ul  id="leftSubMenu">
  ...
  <?php if(ereg('wheel-intro',$slug)) { echo "<span class='selected-link'>"; } ?>
  <li class="mainHeader"><?php echo link_to("Introduction","@sf_cms_show?slug=wheel-intro&sf_culture=".$sf_user->getCulture());?></li>
  <?php if(ereg('wheel-intro',$slug)) { echo "</span>"; } ?>

  <?php if(ereg('wheel-intro',$slug)){ ?>
  <ul class="subLinks">
  ...
  <?php if(ereg('wheel-planning',$slug)) { echo "<span class='selected-link'>"; } ?>
  <li class="mainHeader"><?php echo link_to("Planning","@sf_cms_show?slug=wheel-planning&sf_culture=".$sf_user->getCulture());?></li>
  <?php if(ereg('wheel-planning',$slug)) { echo "</span>"; } ?>

  <?php if(ereg('wheel-planning',$slug)){ ?>
  <ul class="subLinks">
  ...
  <?php if(ereg('wheel-recruitment',$slug)) { echo "<span class='selected-link'>"; } ?>
  <li class="mainHeader"><?php echo link_to("Recruitment","@sf_cms_show?slug=wheel-recruitment&sf_culture=".$sf_user->getCulture());?></li>
  <?php if(ereg('wheel-recruitment',$slug)) { echo "</span>"; } ?>

  <?php if(ereg('wheel-recruitment',$slug)){ ?>
  <ul class="subLinks">
  ...
  <?php if(ereg('wheel-selection',$slug)) { echo "<span class='selected-link'>"; } ?>
  <li class="mainHeader"><?php echo link_to("Selection","@sf_cms_show?slug=wheel-selection&sf_culture=".$sf_user->getCulture());?></li>
  <?php if(ereg('wheel-selection',$slug)) { echo "</span>"; } ?>

  <?php if(ereg('wheel-selection',$slug)){ ?>
  <ul class="subLinks">
  ...
  <?php if(ereg('wheel-hiring',$slug)) { echo "<span class='selected-link'>"; } ?>
  <li class="mainHeader"><?php echo link_to("Hiring","@sf_cms_show?slug=wheel-hiring&sf_culture=".$sf_user->getCulture());?></li>
  <?php if(ereg('wheel-hiring',$slug)) { echo "</span>"; } ?>

  <?php if(ereg('wheel-hiring',$slug)){ ?>
  <ul class="subLinks">
  ...
  <?php if(ereg('wheel-orientation',$slug)) { echo "<span class='selected-link'>"; } ?>
  <li class="mainHeader"><?php echo link_to("Orientation","@sf_cms_show?slug=wheel-orientation&sf_culture=".$sf_user->getCulture());?></li>
  <?php if(ereg('wheel-orientation',$slug)) { echo "</span>"; } ?>

  <?php if(ereg('wheel-orientation',$slug)){ ?>
  <ul class="subLinks">
