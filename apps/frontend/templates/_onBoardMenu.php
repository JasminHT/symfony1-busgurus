...
<ul  id="leftSubMenu">
  ...
  <?php if(ereg('onboard-needs',$slug)) { echo "<span class='selected-link'>"; } ?>
  <li class="mainHeader">
    <?php echo link_to("Needs Assessment","@sf_cms_show?slug=onboard-needs&sf_culture=".$sf_user->getCulture());?></li>
  <?php if(ereg('onboard-needs',$slug)) { echo "</span>"; } ?>
  
  <?php if(ereg('onboard-image',$slug)) { echo "<span class='selected-link'>"; } ?>
  <li class="mainHeader"><?php echo link_to("Behaviour and Image","@sf_cms_show?slug=onboard-image&sf_culture=".$sf_user->getCulture());?></li>
  <?php if(ereg('onboard-image',$slug)) { echo "</span>"; } ?>
  
  <?php if(ereg('onboard-optimize',$slug)) { echo "<span class='selected-link'>"; } ?>
  ...
  <?php if(ereg('onboard-optimize',$slug)) { echo "</span>"; } ?>
  
  <?php if(ereg('onboard-attracting',$slug)) { echo "<span class='selected-link'>"; } ?>
  ...
  <?php if(ereg('onboard-attracting',$slug)) { echo "</span>"; } ?>

    <?php if(ereg('onboard-recruitment',$slug)) { echo "<span class='selected-link'>"; } ?>
  ...
  <?php if(ereg('onboard-recruitment',$slug)) { echo "</span>"; } ?>
  
  <?php if(ereg('onboard-development',$slug)) { echo "<span class='selected-link'>"; } ?>
  <li class="mainHeader"><?php echo link_to("Development","@sf_cms_show?slug=onboard-development&sf_culture=".$sf_user->getCulture());?></li>
  <?php if(ereg('onboard-development',$slug)) { echo "</span>"; } ?>

  <!-- sub menu -->

  <?php if(ereg('onboard-needs',$slug)) { ?>
  <ul class="subLinks">
  ...
  <?php if(ereg('onboard-optimize',$slug)) { ?>
  <ul class="subLinks">
  ...
  <?php if(ereg('onboard-retaining',$slug) || ereg('onboard-attracting',$slug)) { ?>
  <ul class="subLinks">
  ...
  <?php if(ereg('onboard-recruitment',$slug)) { ?>
  <ul class="subLinks">
  ...
  <?php if(ereg('onboard-image',$slug)) { ?>
    <ul class="subLinks" style='position:relative;float:right;margin-top:-16em'>
...
<ul  id="leftSubMenu">
  ...
  <?php if(ereg('onboard-retaining-retention',$slug)) { echo "<span class='selected-link'>"; } ?>
  ...
  <?php if(ereg('onboard-retaining-retention',$slug)) { echo "</span>"; } ?>
