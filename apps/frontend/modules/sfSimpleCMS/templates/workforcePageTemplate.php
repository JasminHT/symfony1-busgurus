...
<div id="cms" class="workforce">
  ...
  <iframe width='751' height='422' src='https://www.youtube.com/embed/26Pc2clNepQ?rel=0&autoplay=1&showinfo=0' allow='autoplay; encrypted-media' frameborder='0'></iframe>
  <?php } else { ?>
  <iframe width='751' height='422' src='https://www.youtube.com/embed/UPDYFwdoB_4?rel=0&autoplay=1&showinfo=0' allow='autoplay; encrypted-media' frameborder='0'></iframe>
  <?php } ?>
