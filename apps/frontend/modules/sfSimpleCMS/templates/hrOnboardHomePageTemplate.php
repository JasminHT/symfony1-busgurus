...
<div id="cms" class="onboard">
  ...
  <div id='onboard-header-menu'>
    <?php include_partial('global/onBoardHeaderMenu', array('slug' => $page->getSlug(),'culture' => $culture)) ?>
    </div>
  <div id="subnav"> <?php echo link_to(image_tag($sf_user->getCulture().'/onboard.png', "width=177 height=66  class='toolsTitle'   alt=". __('HR ONBOARD')),"@sf_cms_show?slug=onboard&sf_culture=".$sf_user->getCulture());?>
  ...
  <div id="mainText">
    <div id="textBg" class='rounded'>
      ...
      <?php /* include_partial('global/onBoardBlueMenu', array('slug' => $page->getSlug(),'culture' => $culture)); */ ?>
      <br />
  ...
  <div id="leftnav">
    <?php if($page->getSlug() != "onboard"){ ?>
    <img src="/busgurus/images/tools-icon-onboard.jpg" width="181" height="136" alt="onBoard" />
    <?php } ?>
