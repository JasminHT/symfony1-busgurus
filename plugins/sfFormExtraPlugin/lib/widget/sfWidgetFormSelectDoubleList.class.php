...
class sfWidgetFormSelectDoubleList extends sfWidgetForm
{
  ...
  protected function configure($options = array(), $attributes = array())
  {
    ...
    $this->addOption('unassociate', '<img src="/busgurus/sfFormExtraPlugin/images/next.png" alt="unassociate" />');
    $this->addOption('associate', '<img src="/busgurus/sfFormExtraPlugin/images/previous.png" alt="associate" />');
