...
function include_editor_tools($page,$edit_form = null,$create_form = null)
{
  if (sfContext::getInstance()->getRequest()->getParameter('edit') == 'true' && !sfConfig::get('app_sfSimpleCMS_disable_editor_toolbar', false))
  {
    ...
    include_component('sfSimpleCMS', 'editorTools', array('page' => $page,'edit_form'=>$edit_form,'create_form'=>$create_form));
  }
}
