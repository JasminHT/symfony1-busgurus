...
/**
 * Base class that represents a row from the 'sf_simple_cms_slot' table.
 *
 * 
 *
...
abstract class BasesfSimpleCMSSlot extends BaseObject  implements Persistent {
  ...
  const PEER = 'sfSimpleCMSSlotPeer';

	/**
	 * The Peer class.
	 * Instance provides a convenient way of calling static methods on a class
	 * that calling code may not be able to identify.
	 * @var        sfSimpleCMSSlotPeer
	 */
	...
	/**
	 * Initializes internal state of BasesfSimpleCMSSlot object.
	 * @see        applyDefaults()
	 */
	 ...
	 * @return     sfSimpleCMSSlot The current object (for fluent API support)
	 */
	...
	public function hasOnlyDefaultValues()
	{
			...
			if (array_diff($this->modifiedColumns, array(sfSimpleCMSSlotPeer::TYPE))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 7; // 7 = sfSimpleCMSSlotPeer::NUM_COLUMNS - sfSimpleCMSSlotPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function ensureConsistency()
	{
		...
		if ($this->asfSimpleCMSPage !== null && $this->page_id !== $this->asfSimpleCMSPage->getId()) {
			$this->asfSimpleCMSPage = null;
		}
	} // ensureConsistency
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = sfSimpleCMSSlotPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    foreach (sfMixer::getCallables('BasesfSimpleCMSSlot:save:post') as $callable)
    {
      call_user_func($callable, $this, $con, $affectedRows);
			...
			sfSimpleCMSSlotPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->asfSimpleCMSPage !== null) {
				if ($this->asfSimpleCMSPage->isModified() || $this->asfSimpleCMSPage->isNew()) {
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of sfSimpleCMSSlot (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     sfSimpleCMSSlot Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 * @throws     PropelException
	 */
	public function setsfSimpleCMSPage(sfSimpleCMSPage $v = null)
	{
		if ($v === null) {
			$this->setPageId(NULL);
		} else {
	 ...
	 * @throws     PropelException
	 */
	public function getsfSimpleCMSPage(PropelPDO $con = null)
	{
		if ($this->asfSimpleCMSPage === null && ($this->page_id !== null)) {
			$c = new Criteria(sfSimpleCMSPagePeer::DATABASE_NAME);
			$c->add(sfSimpleCMSPagePeer::ID, $this->page_id);
			$this->asfSimpleCMSPage = sfSimpleCMSPagePeer::doSelectOne($c, $con);
			/* The following can be used additionally to
			   guarantee the related object contains a reference
			   to this object.  This level of coupling may, however, be
			   undesirable since it could result in an only partially populated collection
			   in the referenced object.
			   $this->asfSimpleCMSPage->addsfSimpleCMSSlots($this);
			 */
		}
