...
abstract class BasesfSimpleCMSPagePeer {
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new sfSimpleCMSPageMapBuilder();
		}
    ...
    foreach (sfMixer::getCallables('BasesfSimpleCMSPagePeer:doCount:doCount') as $callable)
    {
    ...
    foreach (sfMixer::getCallables('BasesfSimpleCMSPagePeer:doSelectStmt:doSelectStmt') as $callable)
    {
      call_user_func($callable, 'BasesfSimpleCMSPagePeer', $criteria, $con);
    }
    ...
    foreach (sfMixer::getCallables('BasesfSimpleCMSPagePeer:doSelectJoinAll:doSelectJoinAll') as $callable)
    {
      call_user_func($callable, 'BasesfSimpleCMSPagePeer', $c, $con);
    }
  ...
  static public function getUniqueColumnNames()
  {
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		} elseif ($values instanceof sfSimpleCMSPage) {
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$c = new Criteria(sfSimpleCMSSlotPeer::DATABASE_NAME);
			
			$c->add(sfSimpleCMSSlotPeer::PAGE_ID, $obj->getId());
			$affectedRows += sfSimpleCMSSlotPeer::doDelete($c, $con);
		}
		return $affectedRows;
	}
...
//
// NOTE: This static code cannot call methods on the sfSimpleCMSPagePeer class, because it is not defined yet.
// If you need to use overridden methods, you can add this code to the bottom of the sfSimpleCMSPagePeer class:
//
// Propel::getDatabaseMap(sfSimpleCMSPagePeer::DATABASE_NAME)->addTableBuilder(sfSimpleCMSPagePeer::TABLE_NAME, sfSimpleCMSPagePeer::getMapBuilder());
//
// Doing so will effectively overwrite the registration below.

Propel::getDatabaseMap(BasesfSimpleCMSPagePeer::DATABASE_NAME)->addTableBuilder(BasesfSimpleCMSPagePeer::TABLE_NAME, BasesfSimpleCMSPagePeer::getMapBuilder());
