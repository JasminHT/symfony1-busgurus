  ...
  <div class="login">
    <div class="login-form">
      <form action="<?php echo url_for('@sf_guard_signin') ?>" method="post">
        <img alt="Login" src="/busgurus/sfAdminDashPlugin/images/login.gif" />
    ...
    <div class="login-text">
      <div class="ctr"><img alt="Security" src="/busgurus/sfAdminDashPlugin/images/login_security.png" /></div>
      <p><?php echo __('Welcome to %%site%%', array('%%site%%' => sfAdminDash::getProperty('site'))); ?></p>
